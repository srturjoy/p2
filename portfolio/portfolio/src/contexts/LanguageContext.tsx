...
const translations: Translations = {
  ...
  tagline: {
    ...
    bn: 'ডেটা-নির্ভর মার্কেটিং, উন্নত অ্যানালিটিক্স এবং AI অটোমেশন ব্যবহার করে ব্র্যান্ডকে দ্রুত এগিয়ে নিয়ে যেতে সাহায্য করি।',
  },
  ...
  aboutP1: {
    ...
    bn: 'আমি সিদ্দিকুর রহমান — ঢাকায় অবস্থিত একজন ফলাফলমুখী ডিজিটাল মার্কেটিং কৌশলবিদ এবং বুস্টিং এজেন্সি বিডি-র প্রতিষ্ঠাতা। শুধু বিজ্ঞাপন চালানো নয়, আমার কাজ হলো ডেটা-নির্ভর একটি শক্তিশালী রাজস্ব ইঞ্জিন গড়ে তোলা।',
  },
  aboutP2: {
    ...
    bn: 'পারফরম্যান্স মার্কেটিং ও ডেটা অ্যানালিটিক্সে গভীর দক্ষতা নিয়ে আমি সৃজনশীল কৌশল ও প্রযুক্তিগত বাস্তবায়নের মাঝে সেতু তৈরি করি। Python, SQL এবং AI অটোমেশন ব্যবহার করে লুকানো তথ্য বের করি, কনভার্সন রেট বাড়াই এবং বিশ্বজুড়ে ব্র্যান্ডের দ্রুত বিকাশ নিশ্চিত করি।',
  },
  ...
  svc5Desc: { en: 'Implementing AI tools and automated workflows to streamline operations, personalize outreach, and save time.', bn: 'AI টুল ও স্বয়ংক্রিয় ওয়ার্কফ্লো দিয়ে কাজ গোছান, আউটরিচ ব্যক্তিগত করুন এবং মূল্যবান সময় বাঁচান।' },
  svc5Detail: {
    ...
    bn: 'মার্কেটিংয়ের ভবিষ্যৎ এখন স্বয়ংক্রিয় ও বুদ্ধিমান। আমরা পুরোপুরি AI-চালিত মার্কেটিং সিস্টেম তৈরি করি — Python-ভিত্তিক লিড স্কোরিং মডেল, GPT-চালিত ব্যক্তিগতকৃত ইমেইল সিকোয়েন্স, স্বয়ংক্রিয় ক্রিয়েটিভ টেস্টিং পাইপলাইন এবং ২৪/৭ লিড কোয়ালিফিকেশনের জন্য AI চ্যাটবট। আমাদের ক্লায়েন্টরা সাধারণত প্রতি সপ্তাহে ১৫-২৫ ঘণ্টা ম্যানুয়াল মার্কেটিং কাজ থেকে বেঁচে যান।',
  },

  svc6Title: { en: 'Server-Side Tracking & Attribution', bn: 'সার্ভার-সাইড ট্র্যাকিং ও অ্যাট্রিবিউশন' },
  svc6Desc: { en: 'Eliminate data loss from ad-blockers and iOS restrictions. Build bulletproof server-side tracking with Meta CAPI and GA4.', bn: 'অ্যাড-ব্লকার ও iOS রেস্ট্রিকশন থেকে ডেটা ক্ষয় দূর করুন। Meta CAPI ও GA4 দিয়ে শক্তিশালী সার্ভার-সাইড ট্র্যাকিং তৈরি করুন।' },
  svc6Detail: {
    en: "Most brands are flying blind — losing 30-40% of their conversion data to iOS updates, ad-blockers, and cookie consent friction. We migrate your tracking from client-side GTM to a fully server-side architecture on Google Cloud. We implement Meta Conversions API (CAPI) with event deduplication, GA4 server-side streaming, and a custom consent layer that's fully GDPR compliant. The result: 100% data accuracy, better algorithm signals, and campaigns that optimize on real data — not ghosts.",
    bn: 'বেশিরভাগ ব্র্যান্ড iOS আপডেট, অ্যাড-ব্লকার এবং কুকি সম্মতির কারণে ৩০-৪০% কনভার্সন ডেটা হারিয়ে অন্ধকারে কাজ করছে। আমরা আপনার ট্র্যাকিং ক্লায়েন্ট-সাইড GTM থেকে Google Cloud-এ সম্পূর্ণ সার্ভার-সাইড আর্কিটেকচারে নিয়ে যাই। Meta CAPI, GA4 সার্ভার-সাইড স্ট্রিমিং এবং GDPR-সম্মত কনসেন্ট লেয়ার বাস্তবায়ন করি। ফলাফল: ১০০% ডেটা নির্ভুলতা এবং বাস্তব ডেটায় অপ্টিমাইজ হওয়া ক্যাম্পেইন।',
  },

  svc7Title: { en: 'Email Marketing & Automation', bn: 'ইমেইল মার্কেটিং ও অটোমেশন' },
  svc7Desc: { en: 'Build revenue-generating email systems — automated welcome flows, re-engagement sequences, and AI-personalized campaigns.', bn: 'রাজস্ব তৈরিকারী ইমেইল সিস্টেম গড়ুন — স্বয়ংক্রিয় ওয়েলকাম ফ্লো, রি-এনগেজমেন্ট সিকোয়েন্স এবং AI-ব্যক্তিগতকৃত ক্যাম্পেইন।' },
  svc7Detail: {
    en: 'Email is still the highest-ROI channel in digital marketing — when done right. We design, build, and automate complete email marketing ecosystems: welcome series, abandoned cart recovery, post-purchase upsell sequences, win-back campaigns, and weekly newsletters. Using tools like Klaviyo, Mailchimp, or SendGrid, we integrate AI personalization to send the right message, to the right person, at the right time. Average open rates of 35-45% and click rates of 5-8% across our client accounts.',
    bn: 'সঠিকভাবে করলে ইমেইল এখনো ডিজিটাল মার্কেটিংয়ের সবচেয়ে বেশি ROI দেওয়া চ্যানেল। আমরা সম্পূর্ণ ইমেইল মার্কেটিং সিস্টেম ডিজাইন ও অটোমেট করি — ওয়েলকাম সিরিজ, কার্ট রিকভারি, পোস্ট-পার্চেজ আপসেল এবং উইন-ব্যাক ক্যাম্পেইন। AI ব্যক্তিগতকরণ যোগ করে সঠিক বার্তা সঠিক সময়ে সঠিক মানুষের কাছে পাঠাই।',
  },

  svc8Title: { en: 'SEO & Content Strategy', bn: 'SEO ও কন্টেন্ট কৌশল' },
  svc8Desc: { en: 'Drive sustainable organic growth with technical SEO, keyword strategy, and high-converting content that ranks and converts.', bn: 'টেকনিক্যাল SEO, কীওয়ার্ড কৌশল ও উচ্চ-রূপান্তরকারী কন্টেন্ট দিয়ে টেকসই অর্গানিক বৃদ্ধি অর্জন করুন।' },
  svc8Detail: {
    en: 'Paid ads stop the moment you stop paying. SEO builds compounding, long-term equity. We conduct full technical SEO audits (Core Web Vitals, crawlability, schema markup), keyword gap analysis against your top competitors, and build a content calendar targeting high-intent keywords across informational, commercial, and transactional stages. We have grown brand organic traffic by 180%+ and pushed clients from zero organic presence to page 1 rankings within 6 months. We also optimize for AI search engines (ChatGPT, Perplexity, Gemini) through structured data and semantic content architecture.',
    bn: 'পেইড অ্যাড টাকা বন্ধ হলে থামে। SEO দীর্ঘমেয়াদী মূলধন গড়ে। আমরা সম্পূর্ণ টেকনিক্যাল SEO অডিট, প্রতিযোগী বিশ্লেষণ ও হাই-ইন্টেন্ট কীওয়ার্ড টার্গেট করে কন্টেন্ট ক্যালেন্ডার তৈরি করি। আমরা ব্র্যান্ডের অর্গানিক ট্র্যাফিক ১৮০%+ বাড়িয়েছি এবং ৬ মাসের মধ্যে শূন্য থেকে গুগলের প্রথম পাতায় র‍্যাংক করিয়েছি।',
  },

  svc9Title: { en: 'AI Chatbots & Conversational Marketing', bn: 'AI চ্যাটবট ও কনভার্সেশনাল মার্কেটিং' },
  svc9Desc: { en: 'Deploy intelligent AI chatbots on your website and WhatsApp to qualify leads, answer questions, and book appointments 24/7.', bn: 'ওয়েবসাইট ও WhatsApp-এ বুদ্ধিমান AI চ্যাটবট চালু করে লিড কোয়ালিফাই করুন এবং ২৪/৭ অ্যাপয়েন্টমেন্ট নিন।' },
  svc9Detail: {
    en: 'Your best sales rep never sleeps. We build and deploy custom AI chatbots powered by GPT-4 that act as intelligent, always-on sales and support agents for your brand. These bots qualify inbound leads by asking the right questions, answer product/service FAQs, book discovery calls directly into your calendar, and escalate complex queries to your human team. Deployed on your website, WhatsApp, and Facebook Messenger. Clients see 3-5x more qualified conversations and reduce response time from hours to seconds.',
    bn: 'আপনার সেরা সেলস প্রতিনিধি কখনো ঘুমায় না। আমরা GPT-4-চালিত কাস্টম AI চ্যাটবট তৈরি করি যা ২৪/৭ আপনার ব্র্যান্ডের সেলস ও সাপোর্ট এজেন্ট হিসেবে কাজ করে। এই বটগুলো আসা লিড কোয়ালিফাই করে, প্রশ্নের উত্তর দেয়, সরাসরি ক্যালেন্ডারে ডিসকভারি কল বুক করে। ক্লায়েন্টরা ৩-৫ গুণ বেশি যোগ্য কথোপকথন এবং প্রতিক্রিয়া সময় ঘণ্টা থেকে কমে সেকেন্ডে আসতে দেখেন।',
  },
  ...
  // About extras
  aboutP3: {
    en: "My technical edge sets me apart: I write Python scripts to automate reporting, build SQL pipelines to unify multi-platform data, and deploy AI-powered workflows that save clients 15-25 hours per week. Whether you're a fast-growing e-commerce brand, a B2B SaaS company, or a funded startup — I have the expertise to build and scale your marketing engine.",
    bn: "আমার প্রযুক্তিগত দক্ষতা আমাকে আলাদা করে: আমি রিপোর্টিং অটোমেট করতে Python স্ক্রিপ্ট লিখি, মাল্টি-প্ল্যাটফর্ম ডেটা একত্রিত করতে SQL পাইপলাইন তৈরি করি, এবং AI-চালিত ওয়ার্কফ্লো স্থাপন করি যা ক্লায়েন্টদের সাপ্তাহিক ১৫-২৫ ঘণ্টা সাশ্রয় করে।",
  },
  downloadCV: { en: 'Download Resume', bn: 'রেজুমে ডাউনলোড করুন' },

  // Marquee
  marqueeLabel: { en: 'Platforms & Tools I Master', bn: 'আমি যে প্ল্যাটফর্ম ও টুল আয়ত্ত করেছি' },

  // Footer newsletter
  footerQuickLinks: { en: 'Quick Links', bn: 'দ্রুত লিংক' },
  footerNewsletterTitle: { en: 'Get Marketing Insights', bn: 'মার্কেটিং ইনসাইট পান' },
  footerNewsletterDesc: {
    en: 'Weekly tips on performance marketing, data analytics, and AI automation. No spam.',
    bn: 'পারফরম্যান্স মার্কেটিং, ডেটা অ্যানালিটিক্স এবং AI অটোমেশনে সাপ্তাহিক টিপস। কোনো স্প্যাম নেই।',
  },
  footerNewsletterSuccess: { en: "You're subscribed! Welcome aboard.", bn: 'আপনি সাবস্ক্রাইব করেছেন! স্বাগতম।' },
  footerEmailPlaceholder: { en: 'your@email.com', bn: 'আপনার@ইমেইল.com' },

  // FAQ
  faqBadge: { en: 'FAQ', bn: 'সাধারণ প্রশ্ন' },
  faqHeading: { en: 'Frequently Asked Questions', bn: 'সর্বাধিক জিজ্ঞাসিত প্রশ্ন' },
  faqSubtext: {
    en: 'Common questions from clients about performance marketing, analytics, and working together.',
    bn: 'পারফরম্যান্স মার্কেটিং, অ্যানালিটিক্স এবং একসাথে কাজ করা সম্পর্কে ক্লায়েন্টদের সাধারণ প্রশ্ন।',
  },
  faqCta: { en: 'Have a different question?', bn: 'ভিন্ন কোনো প্রশ্ন আছে?' },
  faqCtaLink: { en: 'Contact me directly.', bn: 'সরাসরি আমার সাথে যোগাযোগ করুন।' },

  faqQ1: { en: 'How quickly can I expect results from your ad campaigns?', bn: 'আপনার অ্যাড ক্যাম্পেইন থেকে কত দ্রুত ফলাফল আশা করা যায়?' },
  faqA1: {
    en: 'Most clients see measurable improvements within the first 2–4 weeks — optimized targeting, reduced CPL, and better ROAS signals. Significant revenue impact typically appears within 60–90 days as the algorithm learns and campaigns are iteratively optimized. I provide weekly performance reports so you always know where things stand.',
    bn: 'বেশিরভাগ ক্লায়েন্ট প্রথম ২-৪ সপ্তাহের মধ্যে পরিমাপযোগ্য উন্নতি দেখেন — অপ্টিমাইজড টার্গেটিং, কম CPL এবং ভালো ROAS সংকেত। উল্লেখযোগ্য রাজস্ব প্রভাব সাধারণত ৬০-৯০ দিনের মধ্যে দেখা যায়।',
  },

  faqQ2: { en: 'What is the minimum ad budget you recommend?', bn: 'আপনি সর্বনিম্ন কত বিজ্ঞাপন বাজেট সুপারিশ করেন?' },
  faqA2: {
    en: 'For Meta or Google Ads, I recommend a minimum of $1,500/month ad spend to get statistically meaningful data for optimization. Below this threshold, campaigns often cannot exit the learning phase fast enough. For lead generation campaigns, $1,000/month can be viable if the target audience is narrow and CPL is manageable.',
    bn: 'Meta বা Google Ads-এর জন্য, আমি সর্বনিম্ন $১,৫০০/মাসের বিজ্ঞাপন ব্যয়ের সুপারিশ করি অপ্টিমাইজেশনের জন্য পরিসংখ্যানগতভাবে অর্থবহ ডেটা পেতে।',
  },

  faqQ3: { en: 'Do you work with international clients outside Bangladesh?', bn: 'আপনি কি বাংলাদেশের বাইরের আন্তর্জাতিক ক্লায়েন্টদের সাথে কাজ করেন?' },
  faqA3: {
    en: "Absolutely — the majority of my active clients are international. I've worked with brands in the US, UK, Singapore, Canada, and Australia. I communicate in English and am comfortable with time-zone scheduling across GMT±8. All work is delivered remotely with full transparency via live dashboards.",
    bn: 'অবশ্যই — আমার বেশিরভাগ সক্রিয় ক্লায়েন্ট আন্তর্জাতিক। আমি মার্কিন যুক্তরাষ্ট্র, যুক্তরাজ্য, সিঙ্গাপুর, কানাডা এবং অস্ট্রেলিয়ার ব্র্যান্ডের সাথে কাজ করেছি।',
  },

  faqQ4: { en: 'What makes you different from other digital marketing agencies?', bn: 'অন্যান্য ডিজিটাল মার্কেটিং এজেন্সি থেকে আপনি কীভাবে আলাদা?' },
  faqA4: {
    en: "Three things: (1) I combine creative marketing strategy with hardcore data engineering — I build the dashboards, write the SQL, and code the automation myself. (2) I'm founder-led — you get direct access to the senior strategist, not an account manager. (3) I charge for results, not activities — every engagement includes clear KPIs and I'm accountable to them.",
    bn: 'তিনটি বিষয়: (১) আমি ক্রিয়েটিভ মার্কেটিং কৌশলকে ডেটা ইঞ্জিনিয়ারিংয়ের সাথে একত্রিত করি। (২) আমি ফাউন্ডার-নেতৃত্বাধীন — আপনি সিনিয়র কৌশলবিদের সাথে সরাসরি যোগাযোগ পান। (৩) আমি ফলাফলের জন্য চার্জ করি, কার্যক্রমের জন্য নয়।',
  },

  faqQ5: { en: 'How do you measure and report campaign performance?', bn: 'আপনি কীভাবে ক্যাম্পেইনের পারফরম্যান্স পরিমাপ ও রিপোর্ট করেন?' },
  faqA5: {
    en: "Every client gets a live Power BI or Looker Studio dashboard connected directly to their ad accounts and analytics platforms. You see spend, ROAS, CPL, conversion rates, and creative performance in real time — updated daily. I also send a detailed weekly insights report highlighting wins, areas of concern, and the next week's action plan.",
    bn: 'প্রতিটি ক্লায়েন্ট একটি লাইভ Power BI বা Looker Studio ড্যাশবোর্ড পান যা সরাসরি তাদের অ্যাড অ্যাকাউন্টের সাথে সংযুক্ত। আপনি রিয়েল টাইমে ব্যয়, ROAS, CPL এবং কনভার্সন রেট দেখতে পান।',
  },

  faqQ6: { en: 'Can you take over and fix an existing underperforming ad account?', bn: 'আপনি কি বিদ্যমান দুর্বল পারফরমিং অ্যাড অ্যাকাউন্ট পরিচালনা ও উন্নত করতে পারেন?' },
  faqA6: {
    en: "Yes — account rescues are a specialty. I start with a comprehensive audit covering account structure, audience strategy, creative performance, attribution setup, and budget allocation. Within 30 days, most rescued accounts show meaningful ROAS improvement. I've taken accounts from 1.2x ROAS to 4-7x within 60–90 days with full structural rebuild.",
    bn: 'হ্যাঁ — অ্যাকাউন্ট রেসকিউ আমার একটি বিশেষত্ব। আমি অ্যাকাউন্ট স্ট্রাকচার, অডিয়েন্স কৌশল এবং অ্যাট্রিবিউশন সেটআপ কভার করে একটি ব্যাপক অডিট দিয়ে শুরু করি।',
  },
};
