...
import { Target, TrendingUp, BarChart3, Bot, Zap, X, Radio, Mail, Search, MessageSquare } from 'lucide-react';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Button } from '@/components/ui/button';

type ServiceKey = 'svc1' | 'svc2' | 'svc3' | 'svc4' | 'svc5' | 'svc6' | 'svc7' | 'svc8' | 'svc9';
...
const serviceConfig: { key: ServiceKey; icon: React.ElementType; color: string; accentColor: string }[] = [
  ...
  { key: 'svc6', icon: Radio,          color: 'text-red-400',     accentColor: 'from-red-400/20 to-red-500/5' },
  { key: 'svc7', icon: Mail,           color: 'text-yellow-400',  accentColor: 'from-yellow-400/20 to-yellow-500/5' },
  { key: 'svc8', icon: Search,         color: 'text-teal-400',    accentColor: 'from-teal-400/20 to-teal-500/5' },
  { key: 'svc9', icon: MessageSquare,  color: 'text-pink-400',    accentColor: 'from-pink-400/20 to-pink-500/5' },
];
                ...
                >
                  ...
                  <CardHeader className="relative z-10">
                    <motion.div
                      ...
                      className="w-12 h-12 rounded-lg bg-background flex items-center justify-center border border-border mb-4 group-hover:border-primary/40 transition-all duration-300 w-fit"
                    >
